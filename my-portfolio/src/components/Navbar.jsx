...
//     return (
//       <Flex justify="flex-end" align="center" bg="#1DA1F2" color="white" p={2} as="nav"
//       position="fixed"
//       top={0}
//       left={0}
//       right={0}
...
//           <Link bg="#318ce7" color="black" border="none" mr={4} className="nav-link about" to="aboutSection" smooth={true} duration={500}>About</Link>
...
//                   bg={"white"} border={"none"} color={"black"}  borderRadius={5} p={5} fontSize={15}>Resume</Button>
//         </Flex>
//       </Flex>
//     );
//   }
